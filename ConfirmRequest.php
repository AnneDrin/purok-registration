...
function Confirmrequest($conn, $userId) {
    // Set the timezone to 'Asia/Manila'
    date_default_timezone_set('Asia/Manila');

    // Use prepared statements to prevent SQL injection
    $sql = "UPDATE request_documents SET is_confirmed = 'confirmed', confirm_by_president = ? WHERE id = ? AND is_confirmed = 'unconfirm'";
