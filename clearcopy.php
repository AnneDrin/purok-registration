    ...
    if (isset($headers['Authorization'])) {
        ...
        if (strpos($authHeader, 'Bearer') === 0) {
            ...
            if ($decoded) {
                ...
                // Determine the user type based on your logic
                $userType = determineUserType($decoded->admin_id); // You need to implement this function

                // Call getUserData with the determined user type
